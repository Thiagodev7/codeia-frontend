...
export function AgentCard({ agent, onToggleStatus, onEdit, onDelete }: AgentCardProps) {
  return (
    <div className="bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-xl p-5 relative group hover:border-cyan-200 dark:hover:border-cyan-900/50 transition-all shadow-sm">
